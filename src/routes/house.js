...
router.get('/new', adminMiddle.isAdmin, (req, res) => {
  res.render('new');
});
...
router.get('/:id/edit', adminMiddle.isAdmin, async (req, res) => {
  const house = await House.findById(req.params.id);
  res.render('houseEditForm', { house });
});

router.post('/add', upload.single('image_upload'), adminMiddle.isAdmin, async (request, res) => {
...
router.get('/:id/delete', adminMiddle.isAdmin, async (req, res) => {
